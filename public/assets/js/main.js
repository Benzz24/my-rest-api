(function ($) {
    ...
    $body.on('click', function(e){
        var $target = e.target;
        if (!$($target).is('.mobile-menu-overlay_inner') && !$($target).parents().is('.mobile-menu-overlay_inner') && !$($target).is('#mobile-menu-trigger') && !$($target).is('#mobile-menu-trigger i')){
            $("#mobile-menu-overlay").removeClass("active");
            $body.removeClass('no-overflow');
        }
        if (!$($target).is('.search-overlay_inner') && !$($target).parents().is('.search-overlay_inner') && !$($target).is('#search-overlay-trigger') && !$($target).is('#search-overlay-trigger i')){
            $("#search-overlay").removeClass("active");
            $body.removeClass('no-overflow');
        }
    });
   ...
   // Magnific Popup Image
	...
	$('[data-countdown]').each(function () {
		...
		$this.countdown(finalDate, function (event) {
			$this.html(event.strftime('<div class="single-countdown"><span class="single-countdown_time">%D</span><span class="single-countdowntext">Days</span></div><div class="single-countdown"><span class="single-countdowntime">%H</span><span class="single-countdowntext">Hours</span></div><div class="single-countdown"><span class="single-countdowntime">%M</span><span class="single-countdowntext">Mints</span></div><div class="single-countdown"><span class="single-countdowntime">%S</span><span class="single-countdown_text">Secs</span></div>'));
		});
	});
