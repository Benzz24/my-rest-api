        ...
        <div class="container-fluid container-fluid--cp-100">
                ...
                <div class="col-lg-12 d-none d-md-block">
                    <div class="top-logo-area">
                        <div class="logo text-md-center">
                           <a href="{{route('home')}}"><img src="{{asset('assets/images/logo/Kings Bag .png')}}" 
            ...
            <div class="row align-items-center">
                ...
                <div class="logo_hidden text-start">
                    <a href="{{ route('home') }}"><img src="{{ asset('assets/images/logo/Kings Bag .png') }}" alt="" style="height:40px">
                    </a>
                </div>
                </div>
                ...
                <div class="helendo-tabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="tab__item nav-item active">
                            <button type="button" id="form-login-btn" class="btn btn-full btn-black">Log in</button>
                        </li>
                    ...
                    <div class="tab-pane fade show active" id="tab_list_06" role="tabpanel">
                        <form class="account-form-box" id="form-login">
                            ...
                            <div class="button-box mt-25">
                                <a href="#" type="submit" id="form-login-btn">Log in</a>
                            </div>
                        </form>
